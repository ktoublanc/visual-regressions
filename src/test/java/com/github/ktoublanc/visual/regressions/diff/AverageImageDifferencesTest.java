...
public class AverageImageDifferencesTest {
	...
	public void checkForDifferences_withSameImage() throws Exception {
		final AverageImageDifferences diff = new AverageImageDifferences(referenceImage, referenceImage, 10, 1);
	...
	public void create_withNullReferenceImage() {
		new AverageImageDifferences(null, alteredReferenceImage, 10, 10);
	}

	@Test(expected = NullPointerException.class)
	public void create_withNullAlteredImage() {
		new AverageImageDifferences(referenceImage, null, 0, 10);
	}

	@Test(expected = IllegalArgumentException.class)
	public void create_withNegativeThreshold() {
		new AverageImageDifferences(referenceImage, alteredReferenceImage, -10, 10);
	}
